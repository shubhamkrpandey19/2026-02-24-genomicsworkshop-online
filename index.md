...
venue: "Institute for Modeling Collaboration and Innovation <br> The University of Idaho"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
humandate: "Feb-Mar 24-12, 2026"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "T/Th 3:30-5:45pm PST"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
...
instructor: ["James Van Leuven", <br> Shubham Pandey, "Solana Narum"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
# helper: ["helper one", "helper two"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["jvanleuven@uidaho.edu", "spandey@uidaho.edu", "srnarum@uidaho.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
